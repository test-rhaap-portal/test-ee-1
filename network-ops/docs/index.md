...
```bash
ansible-builder build --file network-ops.yaml --tag network-ops:latest --container-runtime podman
```
...
- **network-ops.yaml**: This is your EE's "blueprint." It's the main definition file that ansible-builder will use to construct your image.
- **network-ops-template.yaml**: This is the Ansible self-service automation portal template file that generated this. You can import it and use it as a base to create new templates for your portal.
...
```bash
# This command uses your 'network-ops.yaml' file to build an image
# and tags it as 'network-ops:latest'
...
```bash
ansible-navigator run playbook.yml --eei network-ops:latest --pull-policy missing
```
...
podman tag network-ops:latest your-pah-hostname/network-ops:latest

# Login to your Private Automation Hub
podman login your-pah-hostname

# Push the image
podman push your-pah-hostname/network-ops:latest
```
...
podman tag network-ops:latest your-internal-registry.com/network-ops:latest
podman login your-internal-registry.com
podman push your-internal-registry.com/network-ops:latest
```
...
If you want to reuse this execution environment template for future projects, you can import the generated **network-ops.yaml** file into your self-service automation portal.
...
2. **Import from Git repository**: Enter the Git SCM URL containing your `network-ops.yaml` file, click **Analyze** to validate, review the details, then click **Import**.
